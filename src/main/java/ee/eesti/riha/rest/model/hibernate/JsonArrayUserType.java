...
/**
 * This class allows to map {@link com.google.gson.JsonArray} to postgresql datatype jsonp. It is based on
...
public class JsonArrayUserType implements UserType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner)
        ...
        return JsonHelper.GSON.fromJson(rs.getString(names[0]), JsonArray.class);
