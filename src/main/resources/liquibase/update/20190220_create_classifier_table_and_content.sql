...
INSERT INTO riha.classifier (id, type, code, json_value, discriminator) VALUES (nextval('riha.classifier_seq'), 'access_restriction_reasons', '23', '{"code": 23, "legislation": "AvTS § 35 lg 1 p 12", "description": "Eraelu puutumatust kahjustav teave"}', 'JSON');
